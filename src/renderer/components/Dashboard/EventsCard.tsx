                  ...
                  <Dialog key={event.id}>
                    <DialogTrigger asChild>
                      <motion.div
                        ...
                        className="border border-zinc-700/50 p-3 rounded-md hover:bg-zinc-800/60 transition-all cursor-pointer"
                      >
                    ...
                    <DialogContent className="bg-zinc-900 border-zinc-700 text-white rounded-xl shadow-2xl">
                      <DialogHeader>
...
- ${new Date(event.end).toLocaleTimeString([], {
                      ...
                      <div className="mt-4 flex justify-end">
                        <Button
                          variant="ghost"
                          className="hover:underline font-light flex items-center gap-1"
                          onClick={() =>
