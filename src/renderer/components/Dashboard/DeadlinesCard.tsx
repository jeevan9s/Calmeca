...
export default function DeadlinesCard() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      // Group tasks by courseId, pick soonest deadline per course
            ...
            <div className="flex flex-col gap-2">
              {loading ? (
                ...
                deadlines.map(({ task, course }) => (
                  <div key={task.id} className="flex flex-col border-b border-zinc-700/50 pb-1 p-1 rounded-lg hover:bg-zinc-800/30">
